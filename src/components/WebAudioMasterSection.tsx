...
const WebAudioMasterSection: React.FC = () => {
  return (
    <section className="space-y-4">
      <div className="bg-slate-900/40 border border-slate-700/60 rounded-xl p-4 sm:p-5">
      ...
      <div className="bg-black/40 border border-slate-700/60 rounded-xl overflow-hidden">
        <iframe
