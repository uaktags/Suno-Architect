...
const VisualizerHeader: React.FC<VisualizerHeaderProps> = ({ 
  ...
  return (
    <div className="bg-[var(--app-panel)] border border-[var(--app-panel-border)]/50 rounded-xl p-6 backdrop-blur-sm">
        <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4 mb-6">
            ...
            <div className="flex gap-2 w-full md:w-auto">
                ...
                className="bg-slate-900 border border-[var(--app-panel-border)] text-slate-300 text-sm rounded-lg p-2.5 focus:ring-[var(--app-accent)]/50 focus:border-[var(--app-accent)] block w-full md:w-64"
                >
        ...
        <input 
            ...
            className="bg-slate-900 border border-[var(--app-panel-border)] text-white text-sm rounded-lg p-2.5 flex-1"
        />
        <button 
