        ...
        {isPreparing && (
            <div className="absolute inset-0 bg-black/60 flex items-center justify-center z-10">
                <div className="flex flex-col items-center">
                    <svg className="animate-spin h-8 w-8 text-[var(--app-accent)] mb-2" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24">
